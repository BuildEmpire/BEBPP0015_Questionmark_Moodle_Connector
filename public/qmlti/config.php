...
define('DB_NAME', 'oci:dbname=//qmmoodle.caaoub65vm2a.eu-west-1.rds.amazonaws.com:1521/qmmoodle');             // e.g. 'sqlite:qmp-lti.sqlitedb' or 'mysql:dbname=qmp-lti;host=localhost'
